...
typedef void (*StorageCallback)(lcb_t, void*, lcb_storage_t, lcb_error_t, lcb_store_resp_t*);
typedef void (*GetCallback)(lcb_t, void*, lcb_error_t, lcb_get_resp_t*);
typedef void (*DelCallback)(lcb_t, void*, lcb_error_t, lcb_remove_resp_t*);
