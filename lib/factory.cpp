...
{
  context = new zmq::context_t context(1, 2);
}
...
{
  return new CommandLineInterpreter cli ( argc, argv );
}
...
{
  return new CouchbaseAdmin cb (conn, pswd);
}
